                    ...
                    <div className="collapse navbar-collapse order-3" id="navbarCollapse">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link to="/Edicion" className="nav-link"> Muebleria </Link>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    ...
                                    {/* <li><Link to="/InsertarProductos" className="dropdown-item">
                                        Insertar </Link></li> */}
                                    <li><Link to="/MostrarProductosEdicion" className="dropdown-item">
                                        Mostrar
                                    </Link></li>
                                </ul>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    ...
                                    {/* <li><Link to="/InsertarCategorias" className="dropdown-item">
                                        Insertar </Link></li> */}
                                    <li><Link to="/MostrarCategoriasEdicion" className="dropdown-item">
                                        Mostrar </Link></li>
                                </ul>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    ...
                                    {/* <li><Link to="/InsertarUsuarios" className="dropdown-item">
                                        Insertar </Link></li> */}
                                    <li><Link to="/MostrarUsuariosEdicion" className="dropdown-item">
                                        Mostrar
                                    </Link></li>
                                </ul>
                            </li>
