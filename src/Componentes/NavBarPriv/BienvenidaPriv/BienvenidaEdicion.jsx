...
const BienvenidaEdicion = () => {
  return (
    <div className="container">
      <div className="jumbotron mt-5">
        <h1 className="display-4">¡Bienvenido Kitzia!</h1>
        <p className="lead">Tienes el Rol de hacer la Edicion de todo lo existente</p>
      </div>
...
export default BienvenidaEdicion;
