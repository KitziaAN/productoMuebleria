...
const BienvenidaInsertar = () => {
  return (
    <div className="container">
      <div className="jumbotron mt-5">
        <h1 className="display-4">¡Bienvenido Alvarado!</h1>
        <p className="lead">Tienes el Rol de hacer la Insercion de todo lo existente</p>
      </div>
...
export default BienvenidaInsertar;
