                    ...
                    <div className="collapse navbar-collapse order-3" id="navbarCollapse">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link to="/Insertar" className="nav-link"> Muebleria </Link>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    ...
                                    <li><Link to="/InsertarProductosInsertar" className="dropdown-item">
                                        Insertar </Link></li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    className="dropdown-menu border-0 shadow">
                                    <li><Link to="/InsertarCategoriasInsertar" className="dropdown-item">
                                        Insertar </Link></li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    className="dropdown-menu border-0 shadow">
                                    <li><Link to="/InsertarUsuariosInsertar" className="dropdown-item">
                                        Insertar </Link></li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1"
                                    className="dropdown-menu border-0 shadow">
                                    <li><Link to="/InsertarEYSInsertar" className="dropdown-item">
                                        Insertar
                                    </Link></li>
